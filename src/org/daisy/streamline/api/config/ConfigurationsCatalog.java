...
public class ConfigurationsCatalog implements ConfigurationsCatalogService {
	...
	public static final ConfigurationsCatalog newInstance() {
		...
		if (iter.hasNext()) {
			...
			provider.setCreatedWithSPI();
			ret.setCustomProvider(provider);
		}
		return ret;
	}
	...
	public void setCustomProvider(UserConfigurationsProvider provider) {
		this.userConfigurations = Optional.of(provider);
	}
	
	// Unset reference added automatically from setCustomProvider annotation
	public void unsetCustomProvider(UserConfigurationsProvider provider) {
